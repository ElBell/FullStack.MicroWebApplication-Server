...
Breaking changes are in rarely used functionality, so we hope upgrade will be smooth for most blogUsers.
 ...
 * Ensure not to use default parsers when there is a blogUser defined one. (kof)
...
* Set default blogUser-agent header. (bevacqua)
