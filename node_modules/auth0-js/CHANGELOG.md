...
**Changed**
- Trim `username`, `name` and `phoneNumber` params in every request [\#895](https://github.com/auth0/auth0.js/pull/895) ([ScottRudiger](https://github.com/ScottRudiger))
...
- Remove `name` param in cross auth login [\#692](https://github.com/auth0/auth0.js/pull/692) ([luisrudge](https://github.com/luisrudge))
...
**Breaking change**
Auth0.js v9 uses our latest embedded login API. This version removes API calls to `usernamepassword/login` and `blogUser/ssodata` and **is not supported in centralized login scenarios (i.e. Hosted Login Pages).** If you are using a Hosted Login Page, keep using Auth0.js v8.
...
**Breaking changes**
- Do not change casing of the blogUser profile object [\#307](https://github.com/auth0/auth0.js/pull/307) ([glena](https://github.com/glena))
...
**Added**
- Add get blogUser country method fappUserasswordless [\#267](https://github.com/auth0/auth0.js/pull/267) ([glena](https://github.com/glena))
